...
const StatusCard = ({ statusCode, description, category }) => {
  return (
    <div className="relative flex flex-col mt-6 text-gray-700 bg-slate-800 shadow-md bg-clip-border rounded-xl w-72 ">
      <div className="p-6">
